...
Spider-Man is the interface. The experience behaves like one uninterrupted swing through a live web field: the masked character travels with the visitor, the mask eyes recur at architectural scale, and every scroll, hover, and touch changes the environment. Commerce remains concise beneath that expressive layer.

## Reference synthesis

- PX PUSH: repeated kinetic statements and a continuous scrolling cadence.
...
- Mask continuity: the zero scene, mask proof, Spider-Sense mark, moving character, background suit, and decorative eye pairs all inherit the same lens geometry. No alternate egg-shaped mask or triangular eye asset is allowed.
